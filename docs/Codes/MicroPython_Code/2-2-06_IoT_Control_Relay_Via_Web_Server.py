'''
 * Filename    : IoT_Control_Relay_Via_Web 
 * Thonny      : Thonny 4.1.7
...
def web_page():
  ...
  <p>Relay state: <strong>""" + gpio_state + """</strong></p><p><a href="/?relay=on"><button class="button">ON</button></a></p>
  <p><a href="/?relay=off"><button class="button button2">OFF</button></a></p></body></html>"""
  return html
